...
class EBViTModelWrapper(UNetModelWrapper):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            ...
            continuous_conditioning=continuous_conditioning,
            y_in_features=y_in_features,
            train_network=train_network,
            train_classifier_free=train_classifier_free,
            **kwargs
        )
    ...
    def potential(self, x, t, y):
        ...
        unet_out = super().forward(t_dummy, x, y=y)
    ...
    def forward(self, t, x, y, return_potential=False, *args, **kwargs):
        """
        ...
        """
        if return_potential:
            return self.potential(x, t, y)
        else:
            return self.velocity(x, t, y)
